...
# 18 "/usr/include/openssl/crypto.h" 2 3 4
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 17 "/usr/include/openssl/asn1.h" 2 3 4
...
# 17 "/usr/include/openssl/rsa.h" 2 3 4
...
# 21 "/usr/include/openssl/engine.h" 2 3 4
...
void EC_KEY_METHOD_get_verify(const EC_KEY_METHOD *meth,
                              ...
                              int (**pverify_sig)(const unsigned char *dgst,
                                                  ...
                                                  const ECDSA_SIG *sig,
                                                  EC_KEY *eckey));
# 23 "/usr/include/openssl/engine.h" 2 3 4
...
int RAND_poll(void);
# 24 "/usr/include/openssl/engine.h" 2 3 4
...
# 16 "/usr/include/openssl/pem.h" 3 4
...
# 30 "/usr/include/openssl/x509.h" 3 4
...
int i2b_PVK_bio(BIO *out, EVP_PKEY *pk, int enclevel,
                pem_password_cb *cb, void *u);
# 20 "/usr/include/openssl/ui.h" 2 3 4
...
# 35 "/usr/include/openssl/err.h" 2 3 4
...
# 26 "/usr/include/openssl/engine.h" 2 3 4
...
void ShowRSAInfo(RSA *rsa){
  { printf("RSA_get0_n(rsa)" "=%s (0x%s)\n", BN_bn2dec(RSA_get0_n(rsa)), BN_bn2hex(RSA_get0_n(rsa))); };
  { printf("RSA_get0_p(rsa)" "=%s (0x%s)\n", BN_bn2dec(RSA_get0_p(rsa)), BN_bn2hex(RSA_get0_p(rsa))); };
  { printf("RSA_get0_q(rsa)" "=%s (0x%s)\n", BN_bn2dec(RSA_get0_q(rsa)), BN_bn2hex(RSA_get0_q(rsa))); };
  { printf("RSA_get0_e(rsa)" "=%s (0x%s)\n", BN_bn2dec(RSA_get0_e(rsa)), BN_bn2hex(RSA_get0_e(rsa))); };
  { printf("RSA_get0_d(rsa)" "=%s (0x%s)\n", BN_bn2dec(RSA_get0_d(rsa)), BN_bn2hex(RSA_get0_d(rsa))); };
}
...
# 37 "rsaTest2.c" 3 4
 OPENSSL_init_crypto(0x00000002L, ((void *)0))
# 37 "rsaTest2.c"
                          ;
...
# 80 "rsaTest2.c"
  ...
  crypted_len = RSA_private_encrypt(strlen(plain_buf), plain_buf, crypted_buf, rsa, 
# 88 "rsaTest2.c" 3 4
                                                                                   1
# 88 "rsaTest2.c"
                                                                                                    );
  ...
  if ( crypted_len == -1 ){
    ...
    decrypted_len = RSA_public_decrypt(crypted_len, crypted_buf, decrypted_buf, rsa, 
# 96 "rsaTest2.c" 3 4
                                                                                    1
# 96 "rsaTest2.c"
                                                                                                     );
